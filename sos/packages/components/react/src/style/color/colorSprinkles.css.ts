...
export const palette = {
  ...
  ...Object.fromEntries(Object.entries(vars.color.$palette.blue).map(([key, value]) => [`blue${key}`, value])),
  ...Object.fromEntries(Object.entries(vars.color.$palette.green).map(([key, value]) => [`green${key}`, value])),
  ...Object.fromEntries(Object.entries(vars.color.$palette.pink).map(([key, value]) => [`pink${key}`, value])),
  ...Object.fromEntries(Object.entries(vars.color.$palette.orange).map(([key, value]) => [`orange${key}`, value])),
  ...Object.fromEntries(Object.entries(vars.color.$palette.gray).map(([key, value]) => [`gray${key}`, value])),
  ...Object.fromEntries(Object.entries(vars.color.$palette.coolGray).map(([key, value]) => [`coolGray${key}`, value])),
  ...Object.fromEntries(Object.entries(vars.color.$palette.blueGray).map(([key, value]) => [`blueGray${key}`, value])),
  ...Object.fromEntries(
    Object.entries(vars.color.$palette.background).map(([key, value]) => [`background${key.charAt(0).toUpperCase() + key.slice(1)}`, value]),
  ),
  ...Object.fromEntries(Object.entries(vars.color.$palette.text).map(([key, value]) => [`text${key.charAt(0).toUpperCase() + key.slice(1)}`, value])),
  ...Object.fromEntries(Object.entries(vars.color.$palette.ui).map(([key, value]) => [`ui${key.charAt(0).toUpperCase() + key.slice(1)}`, value])),
} as const;
