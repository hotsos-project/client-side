...
var shadowSprinkles = _ad2215({ conditions: void 0, styles: { boxShadow: { values: { xs: { defaultClass: "_1ybucis0" }, s: { defaultClass: "_1ybucis1" }, m: { defaultClass: "_1ybucis2" }, l: { defaultClass: "_1ybucis3" }, elevatedTop: { defaultClass: "_1ybucis4" } } } } });
...
var badgeRecipe = _7a4683({ defaultClassName: "_169vsuk3k", variantClassNames: { size: { s: "q5ki0k3y q5ki0k2u q5ki0k29 q5ki0k3d", m: "q5ki0k3y q5ki0k2u q5ki0k29 q5ki0k3d", l: "q5ki0k3z q5ki0k2v q5ki0k2a q5ki0k3e" }, color: { blue: "exp0d747", pink: "exp0d74x", orange: "exp0d75a", green: "exp0d74k" } }, defaultVariants: { size: "m", color: "blue" }, compoundVariants: [] });
...
var Title = ({ children = "\uC81C\uBAA9", color = "textNormal", className, ...props }) => {
  return /* @__PURE__ */ jsx8(Text, { className: clsx_default(titleStyle, className), textType: "title2", textMode: "bold", as: "h1", color, ...props, children });
};
