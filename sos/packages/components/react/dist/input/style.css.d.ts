...
export declare const inputStateStyle: Record<"default" | "disabled" | "highlight" | "warning", string>;
export declare const buttonStyle: string;
export declare const divStateStyle: Record<"default" | "disabled" | "highlight" | "warning", string>;
/**
 * span(왼쪽 아이콘) 공통 스타일
 */
