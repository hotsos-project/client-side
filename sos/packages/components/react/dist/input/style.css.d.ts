...
export declare const inputStateStyle: Record<"default" | "disabled" | "warning" | "highlight", string>;
export declare const buttonStyle: string;
export declare const divStateStyle: Record<"default" | "disabled" | "warning" | "highlight", string>;
/**
 * span(왼쪽 아이콘) 공통 스타일
 */
